...
struct AgeVerifier: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            //Child instructions
            Text("This area is for adults only! If you are a child, click the red square to go back.").font(.custom("Helvetica Bold", size: 35))
                .padding().foregroundColor(Color(red: 0.5804, green: 0.0863, blue: 0))
            Spacer()
